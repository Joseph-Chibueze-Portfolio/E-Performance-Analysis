...
## 📌 Project Overview
This project focuses on analyzing a comprehensive e-commerce dataset to evaluate financial performance, product profitability, and marketing efficiency. I built this dashboard to help stakeholders move beyond raw data and identify exactly which products drive profit.
...
* Refund Impact Analysis: Investigated refund-related losses per product to identify quality or order accuracy issues, specifically highlighting "The Original Mr. Fuzzy" as the highest frequency driver of returns.
